...
## Modificación de los tipos de datos e imputación df_final.
...
## Elimino datos inconsistentes sobre una edad registrada

## Compruebo todos los cambios realizados.
    df_final.info()
    df_final.to_csv('df_final.csv', index=False)  # Guardar df_final como CSV
